...
//    var photo: Photo?
//
//    let cDFetchRequestService: CDFetchRequestService? = nil
//
//    var cloudDataController: CloudDataController?
//    var weatherController = WeatherController()
//
...
//        cloudTableView.dataSource = self
//
//        guard let cDFetchRequestService = cDFetchRequestService else { return }
//        cDFetchRequestService.fetchedResultsController.delegate = self
//
//        cloudLogoLabel.text = "CloudCrowd"
//        //weatherController.fetchWeather(lon: 139, lat: 35)
//    }
...
//    // MARK: - TableView Data Source Methods
//    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
//        guard let cDFetchRequestService = cDFetchRequestService else { return 0 }
//        return cDFetchRequestService.fetchedResultsController.fetchedObjects?.count ?? 0
//    }
//
//    let reuseIdentifier = "CloudCell"
//    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
...
//        }
//
//        guard let cDFetchRequestService = cDFetchRequestService else { return UITableViewCell() }
//
//        let cloud = cDFetchRequestService.fetchedResultsController.object(at: indexPath)
//
//        cell.titleLabel.text = cloud.name
//        cell.subtitleLabel.text = cloud.prefix
//        cell.infoLabel.text = cloud.appearance
...
//        if segue.identifier == "showCloudDetail" {
//            guard let cloudDetailVC = segue.destination as? CloudDetailViewController,
//            let indexPath = cloudTableView.indexPathForSelectedRow,
//            let cDFetchRequestService = cDFetchRequestService else { return }
//            let cloud = cDFetchRequestService.fetchedResultsController.object(at: indexPath)
//            cloudDetailVC.cloud = cloud
//            cloudDetailVC.cloudController = cloudDataController
//        }
